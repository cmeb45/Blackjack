...
// Gives hints from Basic Blackjack Strategy
    ...
    public static String AfterSplitStrategyHints(Player Gamer, Player Dealer, int i){
		...
		// If the player has a hard hand (two starting cards with no aces)
		...
		else if((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() != 1) 
			|| (Gamer.SplitHand[i][0].getFace() != 1 && Gamer.SplitHand[i][1].getFace() == 1)){
			// If the player has a soft hand (one of the starting hands contains an ace)
		    if(((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 2) 
				|| (Gamer.SplitHand[i][0].getFace() == 2 && Gamer.SplitHand[i][1].getFace() == 1)) 
				|| ((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 3) 
				|| (Gamer.SplitHand[i][0].getFace() == 3 && Gamer.SplitHand[i][1].getFace() == 1))){
				// If you have an Ace 2 or Ace 3
				if(Dealer.Score == 5 || Dealer.Score == 6){
				   ReturnString = Gamer.Name+" should double";
				}
			...
			else if(((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 4) 
				|| (Gamer.SplitHand[i][0].getFace() == 4 && Gamer.SplitHand[i][1].getFace() == 1)) 
				|| ((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 5) 
				|| (Gamer.SplitHand[i][0].getFace() == 5 && Gamer.SplitHand[i][1].getFace() == 1))){
				// If you have an Ace 4 or Ace 5
			    if(Dealer.Score >= 4 && Dealer.Score <= 6){
					ReturnString = Gamer.Name+" should double";
				}
			...
			else if((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 6) 
				|| (Gamer.SplitHand[i][0].getFace() == 6 && Gamer.SplitHand[i][1].getFace() == 1)){
				// If you have an Ace 6
				if(Dealer.Score >= 3 && Dealer.Score <= 6){
					ReturnString = Gamer.Name+" should double";
				}
			...
			else if((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 7) 
				|| (Gamer.SplitHand[i][0].getFace() == 7 && Gamer.SplitHand[i][1].getFace() == 1)){
				// If you have an Ace 7
				if(Dealer.Score == 2 || Dealer.Score == 7 || Dealer.Score == 8){
					ReturnString = Gamer.Name+" should stand";
				}
			...
			else if(((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 8) 
				|| (Gamer.SplitHand[i][0].getFace() == 8 && Gamer.SplitHand[i][1].getFace() == 1)) 
				|| ((Gamer.SplitHand[i][0].getFace() == 1 && Gamer.SplitHand[i][1].getFace() == 9) 
				|| (Gamer.SplitHand[i][0].getFace() == 9 && Gamer.SplitHand[i][1].getFace() == 1))){
				// If you have an Ace 8 or Ace 9
				ReturnString = Gamer.Name+" should stand";  
			}
		}
